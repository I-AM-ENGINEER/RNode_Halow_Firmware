...
typedef struct lmac_ah_tx_ctx_t lmac_ah_tx_ctx_t;
...
WRAPV(lmac_check_tx_queue_empty, (void), ())
...
WRAPV(lmac_tx_task, (void *arg), (arg))
WRAPV(lmac_tx_status_task, (void *arg), (arg))
WRAP(int32, lmac_send_data_to_phy, (uint32 ac), (ac))
WRAP(int32, lmac_attempt_tx_obss, (int32 lo_id), (lo_id))
WRAP(int32, lmac_attempt_tx, (uint32 ac), (ac))
...
WRAP(void *, lmac_gen_tx_agglist, (uint32 ac, uint32 ac_hint, uint32 mcs, void *arg), (ac, ac_hint, mcs, arg))
...
WRAP(uint32, tx_pwr_adjust_by_mcs, (uint32 tx_pwr, uint32 mcs), (tx_pwr, mcs))
